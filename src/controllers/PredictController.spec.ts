...
describe('PredictController', () => {
    ...
    describe('image', () => {
        ...
        it(`Should return status ${HttpStatusCode.BadRequest} and general error message if something throws an AxiosError`, async () => {
            const getPredictImage = aiService.getPredictImage as jest.Mock

            getPredictImage.mockRejectedValue(new AxiosError('error'))
